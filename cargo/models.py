...
class Tournament(db.Model):
    ...
    reg_start = db.Column(db.String(255))
    reg_start_time = db.Column(db.String(255))
    reg_end = db.Column(db.String(255))
    reg_end_time = db.Column(db.String(255))
    tour_start = db.Column(db.String(255))
    tour_end = db.Column(db.String(255))
    ...
    admin_wh = db.Column(db.String(255))
    players_wh = db.Column(db.String(255))
    discord_invite = db.Column(db.String(255))
...
class Team(db.Model):
    ...
    p3 = db.Column(db.String(255))
    p4 = db.Column(db.String(255))
    p5 = db.Column(db.String(255))
    p6 = db.Column(db.String(255))
    p7 = db.Column(db.String(255))
    p8 = db.Column(db.String(255))
    p1_steam_id = db.Column(db.String(255))
    p2_steam_id = db.Column(db.String(255))
    p3_steam_id = db.Column(db.String(255))
    p4_steam_id = db.Column(db.String(255))
    p5_steam_id = db.Column(db.String(255))
    p6_steam_id = db.Column(db.String(255))
    p7_steam_id = db.Column(db.String(255))
    p8_steam_id = db.Column(db.String(255))
